...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        num1=74,num2=24;
         NSLog(@"두 수의 덧셈 : %ld + %ld = %ld",num1,num2,[calBox numAdd:num1 num2:num2]);
        num1=47,num2=85;
        NSLog(@"두 수의 뺄셈 : %ld - %ld = %ld",num1,num2,[calBox numSub:num1 num2:num2]);
        num1=24,num2=82;
        NSLog(@"두 수의 곱셈 : %ld * %ld = %ld",num1,num2,[calBox numMulti:num1 num2:num2]);
        num1=47,num2=3;
        NSLog(@"두 수의 나눗셈 : %ld / %ld = %0.3f",num1,num2,[calBox numDiv:num1 num2:num2]);
