...
-(CGFloat)numAdd:(NSInteger)num1 num2:(NSInteger)num2{
    
    CGFloat result;
    
    CGFloat num = (float)num1+(float)num2+0.005;
    
    result = (NSInteger)(num * 100)/100.0;
    
    return result;
}

-(CGFloat)numSub:(NSInteger)num1 num2:(NSInteger)num2{
...
-(CGFloat)numMulti:(NSInteger)num1 num2:(NSInteger)num2{
